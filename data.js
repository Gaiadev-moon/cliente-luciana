(() => {
  ...
  const products = [
    ...
    { id: "difusor-algodon-calido", name: "Difusor Algodón Cálido", category: "Difusores", material: "Aroma limpio", price: 17800, rating: 4.8, badge: "Suave", featured: false, isNew: true, description: "Fragancia limpia y envolvente para crear una sensación de frescura tranquila en dormitorios y salas.", tags: ["Limpio", "Suave", "Ambientes"], type: "lamp", image: "assets/images/aromarte/calma.jpg", imagePosition: "center", palette: ["#e9dfd2", "#66754d", "#fff9f1"] },
    { id: "difusor-madera-serena", name: "Difusor Madera Serena", category: "Difusores", material: "Aroma amaderado", price: 19800, rating: 4.9, badge: "Favorito", featured: true, isNew: false, description: "Notas cálidas y elegantes para acompañar espacios de descanso, lectura o reuniones especiales.", tags: ["Amaderado", "Elegante", "Duradero"], type: "lamp", image: "assets/images/aromarte/brand-calm.jpg", imagePosition: "center", palette: ["#e5d8c8", "#5f704c", "#fff8ee"] },
    { id: "vela-jardin-suave", name: "Vela Jardín Suave", category: "Velas", material: "Cera aromática", price: 14200, rating: 4.7, badge: "Nuevo", featured: false, isNew: true, description: "Una vela de aroma delicado, ideal para sumar luz tenue y un detalle sensorial al final del día.", tags: ["Floral", "Hecha a mano", "Pausa"], type: "lamp", image: "assets/images/aromarte/welcome.jpg", imagePosition: "center", palette: ["#eadfce", "#6d7651", "#fff8ec"] },
    { id: "vela-brisa-verde", name: "Vela Brisa Verde", category: "Velas", material: "Aroma herbal", price: 13500, rating: 4.6, badge: "Fresco", featured: false, isNew: false, description: "Aroma fresco con carácter herbal para cocinas, estudios o rincones donde quieras renovar el ambiente.", tags: ["Herbal", "Fresco", "Ligero"], type: "lamp", image: "assets/images/aromarte/detalle-producto.jpg", imagePosition: "center", palette: ["#e8dccb", "#6b7652", "#fff9f2"] },
    { id: "set-regalo-aromarte", name: "Set Regalo AromArte", category: "Sets", material: "Difusor y vela", price: 32600, rating: 5.0, badge: "Regalo", featured: true, isNew: true, description: "Presentación lista para regalar con una combinación armónica de aroma, textura y detalle decorativo.", tags: ["Regalo", "Completo", "Especial"], type: "lamp", image: "assets/images/aromarte/hero-product.jpg", imagePosition: "center", palette: ["#eadfce", "#6d7651", "#fff8ec"] },
    { id: "ramo-mini-calma", name: "Ramo Mini Calma", category: "Deco", material: "Flores secas", price: 8600, rating: 4.7, badge: "Artesanal", featured: false, isNew: true, description: "Pequeño acento decorativo para bandejas, escritorios o detalles de regalo con presencia natural.", tags: ["Natural", "Mini", "Decorativo"], type: "lamp", image: "assets/images/aromarte/mission.jpg", imagePosition: "center", palette: ["#e9ddcb", "#63704d", "#fff8ef"] },
    { id: "bandeja-ritual-aroma", name: "Bandeja Ritual de Aroma", category: "Deco", material: "Detalle decorativo", price: 21900, rating: 4.8, badge: "Ritual", featured: false, isNew: false, description: "Base decorativa para organizar difusor, vela y flores secas en una composición cálida y equilibrada.", tags: ["Ritual", "Organizador", "Deco"], type: "lamp", image: "assets/images/aromarte/produccion-consciente.jpg", imagePosition: "center", palette: ["#e7daca", "#64724f", "#fff8ee"] }
  ];
